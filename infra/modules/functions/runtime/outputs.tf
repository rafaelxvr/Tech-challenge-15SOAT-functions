output "authorizer_function_arn" {
  ...
  description = "Exact verifier Lambda; this FUN module owns its single HTTP API authorizer binding."
}
...
output "authorizer_id" { value = aws_apigatewayv2_authorizer.request.id }
